    ...
    public function run()
    {
        ...
        DB::table('services_en')->insert([
            ...
            [
                ...
                'name' => 'Route to Makkah Hilton Hotel',
                'description' => 'Direct route guidance from Haram to Makkah Hilton Hotel. Includes walking directions, shuttle timings, and landmark references.',
                'price' => 0.00,
            ...
            [
                ...
                'name' => 'Route to Fairmont Clock Tower',
                'description' => 'Navigation assistance to Fairmont Makkah Clock Royal Tower. Multiple route options and transportation methods available.',
                'price' => 0.00,
            ...
            [
                ...
                'name' => 'Route to Conrad Makkah Hotel',
                'description' => 'Detailed directions to Conrad Makkah hotel with estimated walking times and alternative transportation options.',
                'price' => 0.00,
            ...
            [
                ...
                'name' => 'Route to Movenpick Madinah',
                'description' => 'Complete route guidance from Masjid an-Nabawi to Movenpick Hotel Madinah with shuttle and taxi information.',
                'price' => 0.00,
            ...
            [
                ...
                'name' => 'General Hotel Navigation',
                'description' => 'General navigation assistance for finding your way back to any hotel in Makkah or Madinah using landmarks and GPS coordinates.',
                'price' => 0.00,
